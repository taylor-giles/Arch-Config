    ...
    do
        case $item in 
            ...
            "Plasma_Minimal")
                ...
                pacman -S packagekit-qt5 plasma-systemmonitor plasma-nm plasma-pa dolphin konsole kdeplasma-addons kde-gtk-config kscreen discover khotkeys spectacle bluedevil --noconfirm
                if [ $? -ne 0 ]
                then
